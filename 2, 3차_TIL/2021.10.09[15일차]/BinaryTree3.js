...
BinaryTree.prototype._preOrderTraverseNode = function(node, callback){
  ...
  callback(node); //노드출력
  this._preOrderTraverseNode(node.left, callback); // 왼쪽 진입
  this._preOrderTraverseNode(node.right, callback); // 오른쪽 진입
}
...
BinaryTree.prototype._postOrderTraverseNode = function(node, callback){
  ...
  this._postOrderTraverseNode(node.left, callback); // 왼쪽 진입
  this._postOrderTraverseNode(node.right, callback); // 오른쪽 진입
  callback(node); //노드출력
}
